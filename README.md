...
We pre-trained a model during a training of 45 epochs (c.20h). The weights of the model can be downloaded using this [link](https://drive.google.com/drive/folders/1rQsXRjN6ZPMtKgkicsPUNXE_8ZtO0UyM?usp=share_link)
